...
public class BaseHandler {
    public Map<String, Object> getSysRequestData(GjbbcSysData gjbbcSysdata) throws Exception {
        ...
        requestData.put("mark", Base64.encodeBase64String(GjbbcConstant.SEL_ADD_ORDER_MARK.getBytes("utf-8")));
