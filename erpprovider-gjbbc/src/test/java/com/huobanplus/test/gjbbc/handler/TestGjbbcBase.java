...
public class TestGjbbcBase {
    ...
    public void setUp() {
        ...
        mockGjbbcSysData.setKey("b802c3cd7549da0c05a15cc9aaebfb1c");//a6f0d5db57cc55a5c22c175844665e60
        ...
        mockGjbbcSysData.setRequestUrl("http://oms.goldjet.com.cn/api/index.php?act=bbc&op=bbc_order");//"http://test.goldjet.com.cn/api/index.php?act=bbc&op=bbc_order"
