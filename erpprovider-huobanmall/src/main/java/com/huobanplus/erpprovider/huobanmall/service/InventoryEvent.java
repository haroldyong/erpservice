...
public interface InventoryEvent extends BaseEvent {
     ...
     * 更新入库单信息
     * @param authBean 安全签名参数集合
     * @param inventoryInfo  入库单信息参数集合
     * @return 返回更新入库单结果（成功、失败）
     */
     ...
     * 更新出库单信息
     * @param authBean 安全签名参数集合
     * @param inventoryInfo  出库单信息参数集合
     * @return 返回更新出库单结果（成功、失败）
     */
    ...
    /**
     * 方法描述：按入库单号集合（批量）获取入库单信息
     * 失败处理 提示错误信息，并开启重新查询入库单信息机制
     * @param authBean 安全签名参数集合
     * @param inStorageIds 入库单编号参数集合
     ...
     * @param authBean 安全签名参数集合
     * @param inStorageIds 需要确认的参数集合(入库单IDs)
     * @return 返回确认结果（成功、失败）
     * @since 2015年7月25日 下午4:30:43
     */
     ...
     * 失败处理 提示错误信息，并开启重新确认机制
     * @param authBean 安全签名参数集合
     * @param outStorageIds 需要确认的参数集合(出库单IDs)
     * @return 返回确认结果（成功、失败）
     * @since 2015年7月25日 下午4:30:43
     */
