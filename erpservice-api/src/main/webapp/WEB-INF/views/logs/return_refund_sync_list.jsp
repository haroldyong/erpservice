...
<jsp:useBean id="returnRefundSearch" scope="request"
             type="com.huobanplus.erpservice.datacenter.searchbean.ReturnRefundSearch"/>
<%--
...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            var syncStatus = ${returnRefundSearch.syncStatus};
            $("#syncStatus").val(syncStatus);
        });

        var ajaxUrl = "<c:url value="/erpService/platform/rePushReturnRefund" />";
        function rePush(id) {
                    ...
                    <div class="search-bar">
                        <div>
                            ...
                            <input name="orderId" type="text"
                                   class="input-normal" value="${returnRefundSearch.orderId}"/>
                            ...
                            <input name="beginTime" type="text" id="txtCreateBeginTime" placeholder=" [开始时间]"
                                   ...
                                   style="margin-left: 8px;" value="${returnRefundSearch.beginTime}"/>
                            <label class="first ">---</label>
                            <input name="endTime" type="text" id="txtCreateEndTime" placeholder=" [结束时间]"
                                   class="input-normal Wdate" value="${returnRefundSearch.endTime}"
                            ...
                            <label>
                                ...
                                <a class="btn-lit btn-middle"
                                   href="<c:url value="/erpService/platform/returnRefundSyncs?erpUserType=${erpUserType}" />"
                                   style="margin-bottom: 3px;">
                                    <span>显示全部</span>
                                </a>
                            </label>
            ...
            <div class="cnt-wp" style="padding: 10px 10px 10px;display: block;">
                ...
                <div class="cnt">
                    <table class="data-table even1" width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                        <c:forEach var="log" items="${returnRefundSyncLogs.getContent()}">
                            <tr>
                ...
                <script type="text/javascript">
                    ...
                    var pageCount = ${returnRefundSyncLogs.getTotalPages()};
                    var recordCount = ${returnRefundSyncLogs.getTotalElements()};
