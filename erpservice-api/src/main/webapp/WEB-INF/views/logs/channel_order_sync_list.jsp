                        ...
                        <div>
                            ...
                            <label>
                                ...
                                <a class="btn-lit btn-middle"
                                   href="<c:url value="/erpService/platform/channelOrderSyncs?erpUserType=${erpUserType}" />"
                                   style="margin-bottom: 3px;">
                                    <span>显示全部</span>
                                </a>
                            </label>
            ...
            <div class="cnt-wp" style="padding: 10px 10px 10px;display: block;">
                ...
                <div class="cnt">
                    <table class="data-table even1" width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                        <c:forEach var="log" items="${channelOrderSyncLogs.getContent()}">
                            <tr>
                                ...
                                <td class="txt40 c">${log.orderSyncStatus.name}</td>
                                <td class="txt40 c"><fmt:formatDate value="${log.syncTime}"
                                                                    pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                <td class="txt80 c">
                                    <a href="<c:url value="/erpService/platform/channelOrderSyncList?erpUserType=${erpUserType}&logSyncId=${log.id}" />">查看同步日志</a>
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <script type="text/javascript">
                    ...
                    var pageCount = ${channelOrderSyncLogs.getTotalPages()};
                    var recordCount = ${channelOrderSyncLogs.getTotalElements()};
