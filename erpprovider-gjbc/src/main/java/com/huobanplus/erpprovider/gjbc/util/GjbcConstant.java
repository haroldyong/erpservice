...
public class GjbcConstant {
    ...
    public  final  static  String TEST_REQUEST_URL ="http://test.goldjet.com.cn/api/index.php?act=order_bc&op=order";//http://oms.goldjet.com.cn/api/index.php?act=order_bc&op=order
