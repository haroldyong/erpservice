...
public class GJBCProductHandlerImpl extends BaseHandler implements GJBCProductHandler {
    ...
    @Override
    public EventResult getProductInventoryInfo(ERPInfo erpInfo, GjbcSysData sysData, GjbcInventorySearch gjbcInventorySearch) throws UnsupportedEncodingException {
        //获得请求地址
        GjbcSysData gjbcSysData = JSON.parseObject(erpInfo.getSysDataJson(), GjbcSysData.class);
        String requestUrl = gjbcSysData.getRequestUrl();

//组装系统级参数
        Map<String, Object> requestMap = getSysRequestData(gjbcSysData, "inventory");
