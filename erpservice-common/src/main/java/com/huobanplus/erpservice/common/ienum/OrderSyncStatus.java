...
public interface OrderSyncStatus {
     ...
     * 渠道订单同步状态
     */
    enum ChannelOrderSyncStatus implements ICommonEnum {
        SYNC_SUCCESS(0, "同步成功"),
        SYNC_PARTY_SUCCESS(1, "同步部分成功"),
        SYNC_FAILURE(2, "同步失败"),
        NO_DATA(3, "未获取到同步数据");
        ...
        ChannelOrderSyncStatus(int code, String name) {
            this.code = code;
            this.name = name;
        }
    ...
    enum AuditedSyncStatus implements ICommonEnum {
        SYNC_SUCCESS(0, "同步成功"),
        SYNC_PARTY_SUCCESS(1, "同步部分成功"),
        SYNC_FAILURE(2, "同步失败"),
        NO_DATA(3, "未获取到同步数据");
        ...
        AuditedSyncStatus(int code, String name) {
            this.code = code;
            this.name = name;
        }
